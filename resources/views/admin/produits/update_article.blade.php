                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="nom" class="form-control" required value="{{ $article->nom  }}">
                            </div>
                            <div class="col-lg-6">
                                <label for="nom"> Prix de l'article (hors promo)</label>
                                <input type="number" name="prix" class="form-control" required value="{{ $article->prix  }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                <label for="nom"> Image de l'article</label>
                                <input type="file" class="form-control" name="photo" value="{{ $article->image  }}">
                            </div>
                            <div class="col-lg-6">
                                <label for="nom"> Stock disponible de l'article</label>
                                <input type="number" name="stock_dispo" class="form-control" required value="{{ $article->stock_dispo  }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="prix_promo" class="form-control" required value="{{ $article->prix_promo  }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <textarea class="form-control" required rows="2" name="description"> {{ $article->description  }} </textarea>
